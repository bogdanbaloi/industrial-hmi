...
QString QtPaletteManager::buildStyleSheet(const PaletteDef& palette) {
    ...
    QString qss = QStringLiteral(R"QSS(
        ...
        #sidebarSignOut, #sidebarQuit { background: @surface2; color: @text;
            font-weight: bold; padding: 10px 12px; border: 1px solid @border;
            border-radius: 6px; margin-top: 6px; }
        #sidebarSignOut:hover, #sidebarQuit:hover { background: @accent;
            color: @accentInk; }
